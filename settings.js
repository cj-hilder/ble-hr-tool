...
const FIELDS = [
    ...
    { key: 'BRADYCARDIA_THRESHOLD', label: 'Bradycardia threshold', unit: 'bpm',
      desc: 'If HR drops below this it triggers a heart rate reset — usually set to below your resting heart rate' },
    { group: 'Resting HR' },
    ...
    { key: 'ACTIVE_THRESHOLD_UPPER', label: 'Upper threshold', unit: 'bpm',
      desc: 'If HR exceeds this during activity it will trigger "Rest or pull back". If you are unsure, a conservative starting point is resting HR + 15.' },
    ...
    { key: 'MAX_RECOVERY_PERIOD', label: 'Max recovery period', unit: 's',
      desc: 'Maximum time allowed in the "Rest or pull back" state before a forced HR reset is triggered. Set to 0 for no limit.' },
    { key: 'MAX_RESPONSE_LAG', label: 'Max response lag', unit: 's',
      desc: 'If HR has not started falling within this many seconds of "Rest or pull back", a HR reset is forced. Set to 0 for no limit.' },
    { key: 'NUM_RESETS_B4_WARN', label: 'Resets before warning', unit: '',
      desc: 'Number of HR resets allowed before the app shows a prominent warning to end the session. Set to 0 for no limit.' },
    ...
    { key: 'RFB_SHOW_DEBUG', label: 'Display details', type: 'toggle',
      desc: 'Display wave coherence, phase lag, frequency, and amplitude' },
    { group: 'HRV Reading' },
