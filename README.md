...
- **Sound and vibration alerts** — Configurable intensity on both, designed to be usable while active without watching the screen. Note that the default system vibration is used when the app is not visible — for example, if you switch to another app or turn the screen off.
